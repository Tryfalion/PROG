...
/// Erlaubt es Tests (und potenziell anderen internen Konsumenten), den Broadcast-Kanal direkt
/// zu abonnieren, ohne eine echte WebSocket-Verbindung aufzubauen (Spec 007).
